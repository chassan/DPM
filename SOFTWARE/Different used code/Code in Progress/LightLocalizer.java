...
public class LightLocalizer {
	...
	final double OFFSET = 0; //to correct how much the robot turns after its light localization (where it tries to turn to a heading of 0)
	...
	public void doLocalization() {
		...
		LCD.drawString("x:"+newX,0,1);
		LCD.drawString("y:"+newY,0,2);
		LCD.drawString("h:"+newH,0,3);
