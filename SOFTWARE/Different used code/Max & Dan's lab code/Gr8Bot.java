...
public class Gr8Bot {
	...
	public static final double DEFAULT_WIDTH = 12.3;
	NXTRegulatedMotor leftMotor;
	NXTRegulatedMotor rightMotor;
	private double leftRadius, rightRadius, width;
	private double forwardSpeed, rotationSpeed;
	
	public Gr8Bot(NXTRegulatedMotor leftMotor,
						   NXTRegulatedMotor rightMotor,
						   double width,
						   double leftRadius,
						   double rightRadius) {
	...
	public Gr8Bot(NXTRegulatedMotor leftMotor, NXTRegulatedMotor rightMotor) {
		this(leftMotor, rightMotor, DEFAULT_WIDTH, DEFAULT_LEFT_RADIUS, DEFAULT_RIGHT_RADIUS);
	}
	
	public Gr8Bot(NXTRegulatedMotor leftMotor, NXTRegulatedMotor rightMotor, double width) {
