...
public class LightLocalizer {
	...
	private static final double d = 11.7;	//the variable d from the localization tutorial, the distance from the center of the robot to the light sensor in millimeters, like the odometer
